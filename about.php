        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12 text-center">
                <div class="inner-column">
                    <h1>Selamat Datang di <span>Wijaya Playground</span></h1>
                    <h4>Tentang Kami</h4>
                    <p class="text-justify">
                        Wijaya playground menyewakan istana balon/bouncy terbesar dengan ukuran 4 m x 6 m dan tinggi 8 m. 
                        Kami adalah penyedia wahana bermain terbesar dan termurah di Lampung. Istana balon kami dapat digunakan 
                        untuk event indoor maupun outdoor, baik untuk acara pribadi ataupun corporate.
                    </p>
                    <p class="text-justify">
                        Kami dilengkapi dengan fasilitas generator untuk lokasi dengan listrik terbatas, didukung oleh tim crew 
                        yang profesional untuk membantu dan menjaga selama wahana disewa, serta hadiah menarik yang bisa dibawa 
                        pulang untuk adik-adik yang bermain.
                    </p>
                    <a class="btn btn-lg btn-outline-new-white" href="contact.php">Hubungi Kami</a>
                </div>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-12">
                <img src="images/wahanabermain.jpg" alt="Wijaya Playground" class="img-fluid">
            </div>
        </div>
    </div>
</div>
